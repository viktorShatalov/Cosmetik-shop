...
<div class="about__product">
    ...
    <div class="rigth">
        <div class="about__items">
            <div class="product__name mobile__hide">
                <span class="brand"><?php
	                $categories = $product->get_category_ids();
	                foreach ( $categories as $cat ) {
		                $cat    = get_term( $cat, 'product_cat' );
                    ...
                    <form class="cart"
                        ...
                        <div class="addToCart">
                            <button type="submit" name="add-to-cart"
                                    ...
                                    class="single_add_to_cart_button button alt"><img
                                        src="<?php echo get_template_directory_uri() ?>/assets/img/icon/commerce-and-shopping.png"
                                        alt="Купить товар"></button>
                        </div>
				...
				foreach ( $comments as $comment ) : ?>
                    <div class="review__box-item">
                        <div class="review__box-header">
                            <p class="review__name"><strong><?php echo $comment->comment_author; ?></strong><span
                                        class="review__data"><?php echo date( 'd M Y года', strtotime( $comment->comment_date ) ) ?></span>
                            </p>
