                ...
                <div class="row__link">
                    <div class="top__box">
                        ...
                        <div class="contacts__phone">
                            <a href="tel:0 (800) 50 77 40"><img src="<?php echo get_template_directory_uri() ?>/assets/img/icon/technology.png" alt="mobile-phone"></a>
                        </div>
            ...
            <div class="conteiner m-auto">
                ...
                <div class="change__lang">
                    <p> <?php if ($translations['ru']['current_lang'] == 1) {
                        ...
                        ?></p>
                    <ul>
                        <li><a <?php if ($translations['ru']['current_lang'] == 1) : ?>class="active" <?php endif; ?> href="<?php echo $translations['ru']['url'] ?>">RU</a></li>
                        <li><a <?php if ($translations['uk']['current_lang'] == 1) : ?>class="active" <?php endif; ?> href="<?php echo $translations['uk']['url'] ?>">UA</a></li>
                    </ul>
                </div>
            </div>
        </div>
                                            ...
                                            <ul>
                                                ...
                                                foreach ($cat_child as $cat) : ?>
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <?php $cat_child_child = get_terms([
                                                                'taxonomy'   => 'product_cat',
                                                                'hide_empty' => false,
                                                                'parent'   => $cat->term_id,
                                                            ]);
                                                            foreach ($cat_child_child as $cat_child) : ?>
                                                                <li>
                                                                    <a href="<?php echo get_category_link($cat_child->term_id) ?>"><?php echo $cat_child->name ?></a>
                                                                </li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    </li>
