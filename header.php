            ...
            <div class="conteiner m-auto">
                <div class="mobile__search mobile__content">
                    <button class="search__btn">
                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/icon/interface.png" alt="search__btn">
                    </button>
                    <input type="search" name="search" id="input__search" placeholder="Что вы ищите?">
                </div>
